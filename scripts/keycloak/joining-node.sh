...
wget https://repo1.maven.org/maven2/software/amazon/jdbc/aws-advanced-jdbc-wrapper/2.2.5/aws-advanced-jdbc-wrapper-2.2.5.jar \
    -O "${DOWNLOAD_PATH}/aws-advanced-jdbc-wrapper-2.2.5.jar"

AWS_SDK_VERSION="2.21.10"
AWS_SDK_PACKAGES=(
    "apache-client"
    "auth"
    "aws-core"
